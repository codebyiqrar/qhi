...
const steps = [
  {
    ...
    title: "Chart",
    description:
      "Capture the visit with templates and structured data that stay consistent across providers and locations.",
  },
  {
    id: "2",
    title: "Order",
    description:
      "Send labs, imaging, and referrals from the same workflow—fewer tabs, fewer handoffs, fewer errors.",
  },
  {
    id: "3",
    title: "Review",
    description:
      "Surface results and notifications where clinicians already work so nothing important sits unread in a queue.",
  },
  {
    id: "4",
    title: "Close the loop",
    description:
      "Document follow-up, patient instructions, and billing-ready detail so the record reflects what actually happened in care.",
  },
];
          ...
          <div className="py-10 sm:py-12 lg:py-14">
            <div className="mx-auto max-w-[840px] text-center">
              <h2 className="font-syne text-[30px] font-bold leading-[1.05] tracking-[-0.02em] text-[#0C1428] sm:text-[36px] md:text-[40px] lg:text-[44px] lg:leading-[1.02]">
                <span>From intake to </span>
                <span className="text-primary">sign-off</span>
                <span className="block">One connected clinical flow</span>
              </h2>
              <p className="mx-auto mt-4 max-w-[700px] font-dm-sans text-[14px] leading-normal text-[#3A4A6B] sm:mt-5 sm:text-[15px]">
                QEHR aligns charting, orders, and results so your team spends less time hunting tabs and more time on decisions that improve outcomes.
              </p>
            </div>
