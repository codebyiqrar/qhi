...
const steps = [
    {
        ...
        title: 'Capture',
        description:
            'Instantly record procedures in real time using AI-assisted inputs.',
    },
    {
        id: '2',
        title: 'Validate',
        description:
            'AI validates codes and detects missing or conflicting data.',
    },
    {
        id: '3',
        title: 'Sync',
        description:
            'Smart syncing across EHR, PMS, and all devices, even offline.',
    },
    {
        id: '4',
        title: 'Submit',
        description:
            'Faster claim submissions with analytics tracking and insights.',
    },
]
                    ...
                    <div className="py-10 sm:py-12 lg:py-14">
                        <div className="mx-auto max-w-[840px] text-center">
                            <h2 className="font-syne text-[30px] font-bold leading-[1.05] tracking-[-0.02em] text-[#0C1428] sm:text-[36px] md:text-[40px] lg:text-[44px] lg:leading-[1.02]">
                                ...
                                <span>,</span>
                                <span className="block">From Capture to Claim</span>
                            </h2>
...
export default ChargeCaptureSection6